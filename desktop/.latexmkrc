...
$clean_ext = 'synctex.gz synctex.gz(busy) %R.synctex.gz acn acr alg aux %R.aux bbl bcf blg brf fdb_latexmk glg glo gls idx ilg ind ist lof log lot lox nav nlo nls out run.xml toc dvi bbl rel snm vrb';
