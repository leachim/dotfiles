...
## files to backup
FILES="--include $HOME/Dropbox --include $HOME/.zotero --include $HOME/Data --include $HOME/Github --include $HOME/package-list --exclude $HOME --exclude $HOME/Dropbox/.dropbox.cache"
