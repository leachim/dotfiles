...
slurm_parser.add_argument(
    ...
    default="Data/Logs/{rule}.{wildcards}.out" if "Data/Logs/{rule}.{wildcards}.out" else None)
slurm_parser.add_argument(
...
slurm_parser.add_argument(
    ...
    default="Data/Logs/{rule}.{wildcards}.err" if "Data/Logs/{rule}.{wildcards}.err" else None)
slurm_parser.add_argument(
